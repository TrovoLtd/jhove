...
public class Jpeg2000Module extends ModuleBase {
    ...
    public Jpeg2000Module() {
        ...
        Builder ituBuilder = new Agent.Builder("ITU", AgentType.STANDARD)
                ...
                .email("itumail@itu.int").web("http://www.itu.int/home/");
    ...
    /**
     * Returns the nth <code>Codestream</code>, creating it if necessary, and
     * make it the current one. The value of <code>nCodestreams</code> or
     * <code>nCodestreamHeaders</code> is not affected, even if a new
     * <code>Codestream</code> is created.
     */
     ...
     * <code>true</code>, and the JPX compliance flag is also true, set the MIME
     * type to "image/jpx".
     */
    ...
    /**
     * One-argument version of <code>readUnsignedShort</code>. JPEG2000 is
    ...
    /**
     * One-argument version of <code>readUnsignedInt</code>. JPEG2000 is always
    ...
    /**
     * One-argument version of <code>readSignedLong</code>. JPEG2000 is always
